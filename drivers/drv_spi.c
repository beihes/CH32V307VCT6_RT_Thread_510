...
static rt_err_t ch32_spi_init (struct ch32_spi *spi_drv, struct rt_spi_configuration *cfg) {
    ...
    LOG_D ("sys freq: %ld, pclk2 freq: %ld, SPI limiting freq: %ld, BaudRatePrescaler: %ld", RCC_ClocksStatus.SYSCLK_Frequency, SPI_APB_CLOCK, cfg->max_hz, spi_handle->Init.SPI_BaudRatePrescaler);
